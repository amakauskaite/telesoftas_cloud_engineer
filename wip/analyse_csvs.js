...
function getMaxColumnLengths(data) {
    ...
    data.forEach(function (row) {
        ...
        Object.keys(row).forEach(function (column) {
            ...
            var valueLength = value !== null && value !== undefined ? String(value).length : 0;
...
function processTracks() {
    return __awaiter(this, void 0, void 0, function () {
        var tracks, filteredTracks, maxLengths, artistsSet;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    maxLengths = getMaxColumnLengths(filteredTracks);
...
function processArtists(artistsInTracks) {
    return __awaiter(this, void 0, void 0, function () {
        var artists, filteredArtists, maxLengths;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    maxLengths = getMaxColumnLengths(filteredArtists);
                    console.log(maxLengths);
                    return [2 /*return*/];
            }
        });
